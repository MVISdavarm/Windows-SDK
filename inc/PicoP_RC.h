...
//  PicoP_RC.h
//
//  Contains all possible return codes from the various Microvision PicoP APIs.
//
//  Copyright (C) 2009-2017 Microvision, Inc.
// ****************************************************************************

#ifndef _PICOP_RC_H_
#define _PICOP_RC_H_

// Error codes returned from the ALC,LLC,ALOC and ALJ APIs.
